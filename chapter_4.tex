...
\hl{Upon the application’s launch, the user is introduced to the scenario selection screen as shown in Figure 4.X. Here, the user may choose a specific conversational context according to their personal development goals, including options for academic, professional, and casual social situations. Then, the chatbot is primed with the necessary classmate, allowing the AI Partner to adopt the relevant persona.}
(placeholder image)
