...
The architectural design of Socius is structured to facilitate effective and pragmatically-aware interactions between the user and the chatbot. As illustrated in Figure 4.1, the design is composed of several key components that interact with one another in order to process user input, manage conversation flow, analyze pragmatics, and generate appropriate responses and feedback.
