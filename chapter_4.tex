...
The chatbot system will be built on top of a large lagnuage model (GPT-4) and will follow a conversational AI pipeline:
\begin{itemize}
    ...
    \item \textbf{(Optional) Train with data collator} – Perform fine-tuning on task-specific data.
