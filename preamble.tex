...
%\documentclass[12pt,titlepage,oneside, letterpaper]{article}
...
\usepackage{float}             %-- enables [H] to force figure/table placement
...
\usepackage{longtable, booktabs, array, xcolor, colortbl, ragged2e} % for tables in chapt 6
